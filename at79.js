...
// Função para multiplicar os elementos correspondentes dos dois vetores
function multiplicarVetores(vetor1, vetor2) {
  let vetorResultado = [];
  for (let i = 0; i < vetor1.length; i++) {
    vetorResultado.push(vetor1[i] * vetor2[i]); // Multiplica os elementos correspondentes
  }
...
// Multiplica os vetores e exibe o vetor resultante
const vetorResultado = multiplicarVetores(vetor1, vetor2);
console.log("O vetor resultante da multiplicação dos dois vetores é:", vetorResultado);
